...
namespace DancingLineFanmade.Debugging
{
    public class InLevelDebugLable : MonoBehaviour
    {
        ...
        public void OnGUI()
        {
            string DirLable = Player.instance.transform.rotation.eulerAngles == Player.instance.firstDirection ? "Dir1" : "Dir2";
            if (DrawGUI)
            {
                ...
                //UserInterfaceManager.ShowGUIText("Player方向" + DirLable, Color.black, 30, new Rect(50, 150, 200, 70));
